...
function Team() {
  return (
    <div id='ourteam' className=' relative flex sm:flex-row flex-col gap-3 items-center sm:items-start justify-center min-h-screen w-full pt-16'>
          ...
          <div className='w-96 min-h-[350px] flex flex-col gap-3 items-center justify-start rounded-xl cursor-pointer z-10 p-5 flex-wrap'>
          ...
          <div className='w-96 min-h-[350px] flex flex-col gap-3 items-center justify-start rounded-xl cursor-pointer z-10 p-5'>
